                    ...
                    try:
                        ...
                        try:
                            ...
                            if things_btn.count() > 0 and things_btn.first.is_visible():
                                ...
                                print(
                                    "Things to do button not found, assuming direct results or different layout."
                                )
                        except Exception as e:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Scrape Google Maps Accommodations")
    parser.add_argument(
    ...
    user_data_dir = "google_maps_user_data_accommodations"

    # Regions to scrape
    regions = ["huyện Hoàng Su Phì", "huyện Xín Mần"]

    queries = []
    for region in regions:
        queries.append(f"khách sạn {region}, Hà Giang")
        queries.append(f"homestay {region}, Hà Giang")
